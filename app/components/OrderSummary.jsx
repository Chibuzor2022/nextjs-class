...
//     setUserAddress(addressDummyData); //using dummy data
//   };
//   //called when an address is selcted from dropdown
//   const handleAddressSelect = (address) => {
//     setSelectAddress(address);//set selected address
...
//   };
//   //on componenet mount, fecth addresses
//   useEffect(() => {
//     fetchUserAddresses();
//   }, []);
//   return (
...
//         <div className="">
//           <label classNamer="text-base font-medium uppercase text-gray-600 block mb-2">Select Address</label>
//           <div className="relative inline-block w-full text-sm border">
//             <button className="peer w-full text-left px-4 pr-2 bg-white text-gry-700 focu:outline-none"
