...
const Slider = () => {
  ...
  const data = [
    {
      id: 1,
      title: "Experience Next-Gen Pictures",
      offer: "20% OFF on Cannon Cameras",
      primaryBtn: "Buy Now",
    ...
    },
    {
      ...
      offer: "Apple Elite Headset Out Now",
      primaryBtn: "Order Now",
      secondaryBtn: "Specs",
      image: assets.product_details_page_apple_earphone_image1
    },
    {
      id: 4,
